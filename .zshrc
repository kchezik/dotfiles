...
export GOPATH="/Users/kylechezik/iTerra/Research_Apps/WhiteboxGAT-mac/goSpatial"
export PATH="/Users/kylechezik/iTerra/Research_Apps/WhiteboxGAT-mac/goSpatial/bin:$PATH"
...
export PYTHONPATH="/Users/kylechezik/iTerra/Research_Apps/WBT/:$PYTHONPATH"
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/Users/kylechezik/iTerra/Research_Apps/anaconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/Users/kylechezik/iTerra/Research_Apps/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/kylechezik/iTerra/Research_Apps/anaconda3/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/Users/kylechezik/iTerra/Research_Apps/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda init <<<
